  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-4 w-full max-w-7xl mx-auto">
        <motion.p
          className="text-white text-[16px] sm:text-5xl font-semibold mb-4 -mt-24"
        ...
        <motion.h2
          className="text-[24px] sm:text-6xl md:text-7xl lg:text-[90px] font-extrabold text-white leading-none mb-10"
          initial={{ opacity: 0, y: 30 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
        ...
        <motion.div
          className="w-full max-w-202.25 mb-8 flex flex-col sm:flex-row sm:bg-white/20 sm:backdrop-blur-md sm:rounded-full sm:overflow-hidden sm:border sm:border-white/20 sm:shadow-xl gap-3 sm:gap-0"
      ...
      <motion.div
        className="hidden lg:block absolute bottom-20 left-1/2 -translate-x-1/2 z-10 w-full max-w-313.25 px-4"
        initial={{ opacity: 0, y: 20 }}
        whileInView={{ opacity: 1, y: 0 }}
        viewport={{ once: true }}
            ...
            {ACTIVITIES.map(({ label, icon }) => (
              ...
              >
                <div className="relative w-12 h-12 shrink-0 flex items-center justify-center">
                  <img src="/Star.png" alt="" className="absolute inset-0 w-full h-full object-contain" />
                  <img src={icon} alt="" className="relative z-10 w-5 h-5 object-contain" />
                </div>
