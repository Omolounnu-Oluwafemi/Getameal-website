...
export default function TrustSection() {
  return (
    <section className="py-24 md:py-40 bg-[#FAFAFA] overflow-hidden" id="how-it-works">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          <div className="lg:w-[50%] w-full">
            <motion.div
              className="inline-flex items-center gap-2 bg-[#FAFAFA] border border-gray-200 rounded-full px-6 py-3 md:py-4 mb-4 mt-10 md:mt-0 md:mb-14 shadow-sm"
            ...
            <motion.h2
              className="text-2xl sm:text-5xl font-bold text-gray-900 leading-tight mb-5"
            ...
            <motion.p
              className="text-gray-500 md:leading-relaxed mb-8 md:mb-14 text-sm md:text-[16px]"
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
          ...
          {/* Right column — GIF */}
          <motion.div
            className="order-first lg:order-0 lg:w-[60%] w-full flex items-center justify-center bg-[#FAFAFA]"
        ...
        {/* Download buttons */}
        <motion.div
          className="flex flex-col sm:flex-row gap-3 mt-10 sm:mt-20 w-full"
          initial={{ opacity: 0, y: 25 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          transition={{ duration: 0.5, ease: "easeOut" }}
        >
          ...
          <button className="flex items-center justify-center gap-3 bg-gray-100 text-black font-semibold px-6 py-4 rounded-full flex-1">
            <Image src="/google-play.svg" alt="Google Play" width={18} height={18} />
